...
for suite in test_core.sh test_multi.sh test_adb_race.sh test_multihost.sh test_json.sh test_scan.sh test_hub.sh test_helper.sh test_agent_protocol.sh test_agent_client.sh test_manual.sh; do
  echo
  echo "############ $suite ############"
