...
> —— 這份 README 連同 `docs/` 那幾份整理成一頁，適合傳給同事，打開網址就能看。
> 原始檔是 [`docs/manual.html`](docs/manual.html)，合進 main 後由 GitHub Pages 自動發佈。
> 頁尾蓋著來源的 sha256，對不上就是那一頁落後了；**內容以 repo 裡的 Markdown 為準**。
